...
def report_maneuver_error(current_orbit, initial_orbit, target_orbit):
...
initial_orbit = vessel.orbit
target_orbit = vessel.control.nodes[0].orbit

exec_next_maneuver(vessel)

report_maneuver_error(vessel.orbit, initial_orbit, target_orbit)
